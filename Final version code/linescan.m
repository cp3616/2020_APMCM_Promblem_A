function [hatching_length,line_numbers] = linescan(filename,d,eps,add_data)
    ...
    hatching_length = 0;line_numbers=0;
    parts = regions(picture);
    for k = 1:length(parts)
        current_region = parts(k);
        target = polybuffer(current_region,-d);
